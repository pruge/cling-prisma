...
export const MemberActivityFindFirstOrThrowArgsSchema: z.ZodType<Prisma.MemberActivityFindFirstOrThrowArgs> = z.object({
...
export default MemberActivityFindFirstOrThrowArgsSchema;
